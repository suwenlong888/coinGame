...
public:
    ...
    void setupUi(QMainWindow *MainScene)
    {
        ...
        MainScene->resize(546, 404);
        actionjieshu = new QAction(MainScene);
        actionjieshu->setObjectName(QString::fromUtf8("actionjieshu"));
    ...
    void retranslateUi(QMainWindow *MainScene)
    {
        ...
        actionjieshu->setText(QCoreApplication::translate("MainScene", "\347\273\223\346\235\237", nullptr));
